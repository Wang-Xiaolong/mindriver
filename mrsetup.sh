...
alias mrgl="$MR_SH log -s . | grep -i"
alias mrgt="$MR_SH log -s . | grep -i ' !'"
alias mrgw="$MR_SH log -s . | grep -i ' @'"
alias mrect="$MR_SH edit -q -s '1s/^!//' -s '1s/ !/ /'"
alias mrecw="$MR_SH edit -q -s '1s/^@//' -s '1s/ @/ /'"
